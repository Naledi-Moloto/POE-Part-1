-- ============================================
-- RaceDay Database Script (Revised)
-- Section C: SQL Database Script
-- Users table split into Organisers and Participants
...
CREATE TABLE Results (
    ...
    CONSTRAINT FK_Results_CapturedBy FOREIGN KEY (CapturedByOrganiserID) REFERENCES Organisers(OrganiserID)
);
GO
...
('Sarah van der Merwe', 'sarah.vdm@raceday.co.za', 'HASHED_PASSWORD_2', '0837654321');
GO

-- ---------- Participants (2) ----------
INSERT INTO Participants (FullName, Email, PasswordHash, PhoneNumber, DateOfBirth)
VALUES
('Lindiwe Dlamini', 'lindiwe.dlamini@gmail.com', 'HASHED_PASSWORD_3', '0721112223', '1996-11-05'),
('Michael Botha', 'michael.botha@gmail.com', 'HASHED_PASSWORD_4', '0834445556', '1993-01-30');
GO
...
-- ---------- Events (3) ----------
-- OrganiserID 1 = Thabo Nkosi, OrganiserID 2 = Sarah van der Merwe
...
-- ---------- Enrolments ----------
-- ParticipantID 1 = Lindiwe Dlamini, ParticipantID 2 = Michael Botha
INSERT INTO Enrolments (ParticipantID, CategoryID, BibNumber, Status)
VALUES
(1, 1, 'CM1001', 'Enrolled'),  -- Lindiwe -> Comrades Senior
(1, 3, 'CT2001', 'Enrolled'),  -- Lindiwe -> Cape Town Cycle Tour 109km
(2, 5, 'SW3001', 'Enrolled'),  -- Michael -> Soweto Fun Walk 5km
(2, 4, 'CT2002', 'Enrolled');  -- Michael -> Cape Town Cycle Tour 56km
GO

-- ---------- Results ----------
-- CapturedByOrganiserID 1 = Thabo Nkosi, 2 = Sarah van der Merwe
INSERT INTO Results (EnrolmentID, CapturedByOrganiserID, FinishTime, DistanceCoveredKM, Position, Status)
VALUES
(1, 1, '08:45:12', NULL, 152, 'Finished'),   -- Lindiwe finished the Comrades in 8h45m
(2, 2, '03:12:40', NULL, 45, 'Finished'),    -- Lindiwe finished the Cycle Tour
(3, 1, NULL, 3.50, NULL, 'DNF');             -- Michael did not finish the Soweto walk
GO
